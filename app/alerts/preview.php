...
<html lang="en-US">
	...
	<body>
		<alert-banner class="block w-full bg-[#fff9f8] p-6 relative">
			...
			<div class="box-2 ">
				...
				<div  class=" text-[#E00F00]"><span id="alert_date" class="text-sm">February 1, 2023</span><br><h1 id="banner_title" class="font-bold text-2xl uppercase">Severe Weather Alert</h1></div>

			</div>
			<div class="box-3 ">
				<svg  id="close-alert" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 cursor-pointer">
				  <path fill-rule="evenodd" d="M5.47 5.47a.75.75 0 011.06 0L12 10.94l5.47-5.47a.75.75 0 111.06 1.06L13.06 12l5.47 5.47a.75.75 0 11-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 01-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 010-1.06z" clip-rule="evenodd" />
				</svg>
			</div>
			</div>
			<div id="banner_instructions" class="col-span-full text-[#E00F00]">Vestri haec verecundius, illi fortasse constantius. Duo Reges: constructio interrete. Vestri haec verecundius, illi fortasse constantius.  </div>
		</alert-banner>
		...
		<div class="alerts-banner-wrap w-full p-4 mb-6 bg-[#002460] flex items-center justify-between relative">
			<h1 class="alerts-page-title text-2xl font-bold sm:ml-4 text-white">Preview Alert</h1>
